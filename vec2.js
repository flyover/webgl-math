(function(label, definition) {
  ...
  try {
    vec2.native = vec2.native || require('./build/Release/vec2');
  } catch (err) {}
  try {
    vec2.native = vec2.native || process._linkedBinding('node_vec2');
  } catch (err) {}
  try {
    vec2.native = vec2.native || process.binding('node_vec2');
  } catch (err) {}
