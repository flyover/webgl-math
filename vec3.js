...
var node_vec3 = null;
try { node_vec3 = node_vec3 || require('./build/Release/vec3'); } catch (err) {}
try { node_vec3 = node_vec3 || process._linkedBinding('node_vec3'); } catch (err) {}
try { node_vec3 = node_vec3 || process.binding('node_vec3'); } catch (err) {}
