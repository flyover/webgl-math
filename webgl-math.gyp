{
    ...
    'targets': [
        {
            'target_name': 'libwebgl-math-vec2-<(OS)',
            'type': 'static_library',
            'sources': [ 'vec2.cc' ],
        },
        {
            'target_name': 'libwebgl-math-vec3-<(OS)',
            'type': 'static_library',
            'sources': [ 'vec3.cc' ],
        },
        {
            'target_name': 'libwebgl-math-vec4-<(OS)',
            'type': 'static_library',
            'sources': [ 'vec4.cc' ],
        },
        {
            'target_name': 'libwebgl-math-<(OS)',
            'type': 'static_library',
            'dependencies': [
                #'libwebgl-math-vec2-<(OS)',
                #'libwebgl-math-vec3-<(OS)',
                #'libwebgl-math-vec4-<(OS)',
            ],
            'sources': [
                'vec2.cc',
                'vec3.cc',
